...
# @TEST-EXEC: zeek -C -r ${TRACES}/C37.118_1PMU_TCP.pcap SYNCHROPHASOR::log_data_frame=T SYNCHROPHASOR::log_data_detail=T SYNCHROPHASOR::log_cfg_detail=F  %INPUT
...
#
# @TEST-DOC: Test synchrophasor analyzer with log_cfg_detail disabled
