...
# @TEST-EXEC: zeek -C -r ${TRACES}/C37.118_2PMUsInSync_TCP.pcap SYNCHROPHASOR::log_data_frame=T SYNCHROPHASOR::log_data_detail=T SYNCHROPHASOR::log_cfg_detail=T  %INPUT
