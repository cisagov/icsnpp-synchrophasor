...
# @TEST-EXEC: zeek -C -r ${TRACES}/C37.118_1PMU_UDP_minimal_otherport.pcap SYNCHROPHASOR::log_data_frame=T SYNCHROPHASOR::log_data_detail=T SYNCHROPHASOR::log_cfg_detail=T "SYNCHROPHASOR::synchrophasor_ports_udp={ 40713/udp }" %INPUT
...
#
# @TEST-DOC: Test synchrophasor analyzer with C37.118_1PMU_UDP_minimal_otherport.pcap
